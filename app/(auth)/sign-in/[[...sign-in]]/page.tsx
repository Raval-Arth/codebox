                    ...
                    <div className="space-y-4">
                        <Clerk.Field name="identifier" className="space-y-1">
                            ...
                            <Clerk.Input
                                type="email"
                                required
                                className="w-full px-3 py-2 text-black bg-white border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-yellow-500 focus:translate-y-0.5 focus:shadow-none"
                            />
                        ...
                        <Clerk.Field name="password" className="space-y-1">
                            ...
                            <Clerk.Input
                                type="password"
                                required
                                className="w-full px-3 py-2 text-black bg-white border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-yellow-500"
                            />
                            <Clerk.FieldError className="text-sm text-red-500" />
                        </Clerk.Field>
                    </div>
